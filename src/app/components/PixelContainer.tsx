...
export function PixelContainer({ children, className = "", variant = "neutral" }: PixelContainerProps) {
  ...
  return (
    <div className={`relative bg-black border-4 ${borderColor} p-4 md:p-6 ${className}`}>
